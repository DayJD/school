    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Class Timetable ({{ $getClass['name'] . ' - ' . $getSubject['name'] }})
                            ...
                            <tbody>
                                @foreach ($result as $itemW)
                                    <tr>
                                        ...
                                        <td>{{ !empty($itemW['start_time']) ? date('h:i:A', strtotime($itemW['start_time'])) : '' }}
                                        </td>
                                        <td>{{ !empty($itemW['end_time']) ? date('h:i:A', strtotime($itemW['end_time'])) : '' }}
                                        </td>
