                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div
                                    ...
                                    <a href="{{ url('teacher/my_notice_board') }}" class="btn btn-success">Clear</a>
                    ...
                    <div class="">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                ...
                                {{-- <h6><span class="mailbox-read-time float-right" style="font-weight: bold;color: #000;font-size: 16px">{{ date('d-m-Y' , strtotime($value->publish_date)) }}</span></h6> --}}
                            </div>
                            <div class="card-body">
